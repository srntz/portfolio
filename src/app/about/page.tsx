...
export default function About() {
  ...
  return (
    <div id="about">
      ...
      <AnimatePresence>
        {!exitSequence && (
          <motion.div id="main-content" exit={{ opacity: 0 }} className="px-40">
            {navbarRendered && (
              <>
                <motion.h1
                ...
                <section className="w-full flex gap-16">
                  ...
                  <div id="summary-container" className="flex-1 py-10">
                    ...
                    >
                      Currently, I’m in the final year of the Software
                      Development program at Southern Alberta Institute of
                      Technology, where I’m leading the development of a
                      software solution for Uvaro — an EdTech company dedicated
                      to providing workforce development programs and tools to
                      help people achieve career success.
                    </motion.p>
                  </div>
                </section>
                  ...
                  <div id="cards" className="w-full flex flex-col gap-[2rem]">
                    ...
                    >
                      ...
                      <p className="leading-[1.8rem] opacity-80">
                        I love music, art, and photography, and I can’t imagine
                        my life without being creative and coming up with new
                        ideas for solving problems. Software engineering gives
                        me lots of opportunities to channel my creative thinking
                        and see the results and impact of my work firsthand.
                      </p>
                    </motion.div>
                    <div className="flex gap-[2rem]">
                      ...
                      >
                        ...
                        <p className="leading-[1.8rem] opacity-80">
                          Technology is always evolving, and I love discovering
                          new ways to solve problems and exploring tools that
                          shape our lives. The opportunity to learn along the
                          way makes it even more exciting for me.
                        </p>
                      </motion.div>
                      <motion.div
                        initial={{ top: -20, opacity: 0 }}
                      ...
                      >
                        ...
                        <p className="leading-[1.8rem] opacity-80">
                          I’m passionate about creating solutions that make
                          lives easier, help businesses grow, and contribute to
                          the coummunity. Building meaningful projects brings me
                          a lot of joy.
                        </p>
                      </motion.div>
                    </div>
                  ...
                  <div className={"flex gap-16 items-center"}>
                    ...
                    >
                      <motion.p
                        ...
                        transition={{ delay: 0.15 }}
                      >
                        I love music, production, audio engineering and
                        everything related (you might&#39;ve guessed by looking
                        at my projects). You can always find me listening to
                        something. I also like to share songs and get nerdy
                        about it.
                      </motion.p>
                      <motion.p
                        viewport={{ once: true }}
                        ...
                        transition={{ delay: 0.2 }}
                      >
                        If you are still interested, you may find a playlist
                        with a bunch of my favorite songs here.
                      </motion.p>
                      <motion.button
                        viewport={{ once: true }}
                        initial={{ top: -20, opacity: 0 }}
